    ...
    _contactContainers: function (b) {
      ...
      if (this.containers.length === 1)
        ...
        for (var i = this.items.length - 1; i >= 0; i--) {
          if (
            !a.ui.contains(this.containers[d].element[0], this.items[i].item[0])
          )
            continue;
...
jQuery.ui.dialog.prototype._init = function () {
  ...
  jQuery('#simple_ide_toolbar_tabs').append(
    '<div class="dialog_window_minimized ui-widget ui-state-default ui-corner-all" id="' +
      dialog_id +
      '_minimized">' +
      this.uiDialogTitlebar.find('.ui-dialog-title').text() +
      '<span class="ui-icon ui-icon-newwin"></div>'
  );

  jQuery('#' + dialog_id + '-minbutton')
    .hover(
      function () {
    ...
    .click(function () {
      ...
      jQuery('#' + dialog_id + '_minimized').show();
    });

  jQuery('#' + dialog_id + '_minimized').click(function () {
    jQuery(this).hide();
    dialog_element.open();
  });
};
