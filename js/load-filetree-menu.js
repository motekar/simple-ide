    ...
    if (is_editable) {
        ...
        $menu.append(function() {
            var $item = jQuery("<li>")
                    ...
                    .text("Rename")
                    .on("click", function() {
                        simple_ide_rename_file($this.attr("rel"), function(){alert("Callback")});
                    });
        ...
        $menu.append(function() {
            var $item = jQuery("<li>")
                    ...
                    .text("Delete")
                    .on("click", function() {
                        simple_ide_delete_file($this.attr("rel"), function(){alert("Callback")});
                    });
    ...
    if (is_dir) {
        $menu.append(function() {
            var $item = jQuery("<li>")
                    ...
                    .text("Upload")
                    .on("click", function() {
                        simple_ide_upload_file($this.attr("rel"), function(){alert("Callback")});
                    });
        ...
        $menu.append(function() {
            var $item = jQuery("<li>")
                    ...
                    .text("Download")
                    .on("click", function() {
                        simple_ide_download_file($this.attr("rel"), function(){alert("Callback")});
                    });
    ...
    if (!is_zip) {
        $menu.append(function() {
            var $item = jQuery("<li>")
                    ...
                    .text("Zip")
                    .on("click", function() {
                        simple_ide_zip_file($this.attr("rel"), function(){alert("Callback")});
                    });
        ...
        $menu.append(function() {
            var $item = jQuery("<li>")
                    ...
                    .text("Unzip")
                    .on("click", function() {
                        simple_ide_unzip_file($this.attr("rel"), function(){alert("Callback")});
                    });
...
function simple_ide_rename_file(file, callback_func) {
    var folder = file.replace(/\/[^\/]*?\/?$/, '/'),
        ...
        data = { action: 'simple_ide_rename_file', filename: file, newname: new_name, _wpnonce: jQuery("#_wpnonce").val(),  _wp_http_referer: jQuery('#_wp_http_referer').val() };
...
function simple_ide_delete_file(file, callback_func) {
    var folder = file.replace(/\/[^\/]*?\/?$/, '/'),
        filename = file.replace(folder, ''),
        data = { action: 'simple_ide_delete_file', filename: file, _wpnonce: jQuery("#_wpnonce").val(),  _wp_http_referer: jQuery('#_wp_http_referer').val() };
...
function simple_ide_download_file(file, callback_func) {
    var filename = file.replace(/.*?([^\\\/]+?)$/, '$1'),
        data = { action: 'simple_ide_download_file', filename: file, _wpnonce: jQuery("#_wpnonce").val(), _wp_http_referer: jQuery('#_wp_http_referer').val() };
...
function simple_ide_zip_file(file, callback_func) {
    var folder = file.replace(/\/[^\/]*?\/?$/, '/'),
        data = { action: 'simple_ide_zip_file', filename: file, _wpnonce: jQuery("#_wpnonce").val(),  _wp_http_referer: jQuery('#_wp_http_referer').val() };
...
function simple_ide_unzip_file(file, callback_func) {
    var folder = file.replace(/\/[^\/]*?\/?$/, '/'),
        data = { action: 'simple_ide_unzip_file', filename: file, _wpnonce: jQuery("#_wpnonce").val(),  _wp_http_referer: jQuery('#_wp_http_referer').val() };
